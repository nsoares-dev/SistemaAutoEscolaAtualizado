...
namespace SistemaAutoEscola.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(SistemaAutoEscolaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CarroId,NomeCarro,ModeloCarro,Ano,Placa,Cor,JaReservado")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarroId,NomeCarro,ModeloCarro,Ano,Placa,Cor,JaReservado")] Carro carro)
        {
            if (id != carro.CarroId)
            {
                return NotFound();
